				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="tbl-cell tbl-cell-action">
							<a href="{!! route('category.event.form') !!}" class="btn btn-primary-outine btn-rounded pull-right m-l-1">
                                <i class="fa fa-plus-circle m-r-1"></i>  Neue Eventkategorie
                            </a>
						</div>
					</div>
				</div>
...
$(function() {
    $('#dataTable').DataTable({
        ...
        ajax: {
            type: "POST",
            url: "{!! route('category.event.datatables') !!}"
        },
        columns: [
