...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            {!! Form::model(isset($data) ? $data : null, ['route' => 'category.deal.store', 'autocomplete' => 'off', 'files' => true]) !!}
            ...
            <header class="section-header">
                <div class="tbl">
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            <h3>Eine Dealkategorie {!! isset($data) ? 'bearbeiten' : 'erstellen' !!}</h3>
                            <ol class="breadcrumb breadcrumb-simple">
                                <li><a href="{!! route('category.deal') !!}">Dealkategorien</a></li>
                                @if(isset($data))
                                    <li><a href="{!! route('category.deal.form', $data->id) !!}">{{ $data->name }}</a></li>
                                @endif
                        ...
                        <div class="tbl-cell tbl-cell-action">
                            ...
                            <a href="{{ route('category.deal') }}" class="btn btn-primary-outline btn-rounded pull-right">
