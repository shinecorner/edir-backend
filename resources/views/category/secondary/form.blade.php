...
@section('custom-js')
	...
	<script>
		$(document).ready(function() {
            ...
            $('.multiple-container .select2').select2({
                tags: true,
                multiple: true,
...
@section('content')
    <div class="page-content" id="vue">
        <div class="container-fluid">
            ...
            {!! Form::model(isset($data) ? $data : null, ['route' => 'category.secondary.store', 'autocomplete' => 'off', 'files' => true]) !!}
            ...
            <header class="section-header">
                <div class="tbl">
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            <h3>Eine Unterkategorie {!! isset($data) ? 'bearbeiten' : 'erstellen' !!}</h3>
                            <ol class="breadcrumb breadcrumb-simple">
                                <li><a href="{!! route('category.secondary') !!}">Unterkategorien</a></li>
                                @if(isset($data))
                                    <li><a href="{!! route('category.secondary.form', $data->id) !!}">{{ $data->name }}</a></li>
                                @endif
                        ...
                        <div class="tbl-cell tbl-cell-action">
                            ...
                            <a href="{{ route('category.secondary') }}" class="btn btn-primary-outline btn-rounded pull-right">
                ...
                <div class="col-md-12 col-lg-8">
                    <section class="card">
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-md-4">{{ Form::Fselect('Hauptkategorie', 'category_primary_id', $categoriesprimary) }}</div>
                                <div class="col-md-8">{{ Form::Finput('Name', 'name') }}</div>
                                <div class="col-md-12 multiple-container">{{ Form::Fselectmultiple('Suchkeywörter', 'keywords[]', isset($data) && $data->keywords ? $data->keywords->pluck('keyword', 'keyword')->toArray() : [], null) }}</div>
