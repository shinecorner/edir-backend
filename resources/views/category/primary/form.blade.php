...
@section('content')
    <div class="page-content" id="vue">
        <div class="container-fluid">
            ...
            {!! Form::model(isset($data) ? $data : null, ['route' => 'category.primary.store', 'autocomplete' => 'off', 'files' => true]) !!}
            ...
            <header class="section-header">
                <div class="tbl">
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            <h3>Eine Hauptkategorie {!! isset($data) ? 'bearbeiten' : 'erstellen' !!}</h3>
                            <ol class="breadcrumb breadcrumb-simple">
                                <li><a href="{!! route('category.primary') !!}">Hauptkategorien</a></li>
                                @if(isset($data))
                                    <li><a href="{!! route('category.primary.form', $data->id) !!}">{{ $data->name }}</a></li>
                                @endif
                        ...
                        <div class="tbl-cell tbl-cell-action">
                            ...
                            <a href="{{ route('category.primary') }}" class="btn btn-primary-outline btn-rounded pull-right">
