                    ...
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            ...
                            <ol class="breadcrumb breadcrumb-simple">
                                <li><a href="{{ route('blog') }}">Blogposts</a></li>
                                <li class="active">Übersicht</li>
                            </ol>
                        </div>
                        <div class="tbl-cell tbl-cell-action">
                            <a href="{!! route('blog.form') !!}" class="btn btn-primary-outine btn-rounded pull-right m-l-1">
                                <i class="fa fa-plus-circle m-r-1"></i>  Neuer Blogpost
                            </a>
                        </div>
                    </div>
                </div>
